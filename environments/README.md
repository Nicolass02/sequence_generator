...
After that you can simply use the following comand code to install the environment: "conda env create -f environment_1.yml"

After the environment is completely set up you can activate the conda environment with following comand: "conda activate pyenv"
